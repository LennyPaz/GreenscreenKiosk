...
function createTransactionRow(t) {
  ...
  row.innerHTML = `
    ...
    <td>${t.party_size}</td>
    <td>
      ${escapeHtml(t.background_name)}
      ${t.background_name.toLowerCase() === 'custom' || t.background_name.toLowerCase() === 'custom background'
        ? ` <button class="btn btn-sm btn-secondary" onclick="viewTransactionDetails('${t.customer_number}')" title="View custom background notes" style="margin-left: 8px;">📝 Notes</button>`
        : ''
      }
    </td>
              ...
              <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div style="flex: 1;">
                  ...
                  <div style="color: rgba(255,255,255,0.9); font-size: 13px;">
                    Click to view operator notes for details →
                  </div>
                </div>
              </div>
            </div>
